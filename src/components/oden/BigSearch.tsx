...
const HighlightedMenu: FunctionComponent<{ menu?: MenuProp | string }> = ({
  ...
  return (
    <Combobox.Option value={menu} as={Fragment}>
      <Link
        href={url}
        className="group mb-[1px] rounded-lg px-2 text-gray-500 outline-none ring-inset ring-blue-600 hover:bg-blue-100 focus-visible:ring-2 active:bg-blue-200 ui-active:bg-blue-100 dark:hover:bg-blue-900"
      >
